...
// CoPylot
#define COCOAPODS_POD_AVAILABLE_CoPylot
#define COCOAPODS_VERSION_MAJOR_CoPylot 0
#define COCOAPODS_VERSION_MINOR_CoPylot 1
#define COCOAPODS_VERSION_PATCH_CoPylot 0
